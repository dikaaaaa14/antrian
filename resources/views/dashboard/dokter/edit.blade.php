  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <div class="clearfix">
            <h4 class="card-title float-left">Edit Data petugas</h4>
          </div>
          ...
          <form action="/dashboard/dokter/{{ $dokter->id }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" name="nama_dokter" id="nama_dokter" placeholder="Nama petugas" value="{{ old('nama_dokter', $dokter->nama_dokter ) }}" required>
            @error('nama_dokter')
