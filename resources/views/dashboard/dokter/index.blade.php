  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        ...
        <div class="card-body">
          <div class="clearfix">
            <h4 class="card-title float-left">Daftar Data Petugas</h4>
            <a href="/dashboard/dokter/create" class="btn btn-sm btn-info mb-2"> <i class="mdi mdi-table-row-plus-before"></i> Tambah Data Petugas</a>
          </div>
