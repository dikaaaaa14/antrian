  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <div class="clearfix">
            <h4 class="card-title float-left">Tambah Data petugas</h4>
          </div>
          
          <form action="/dashboard/dokter" method="post" class="col-6">
            @csrf
            <div class="mb-3">
                <label for="nama_dokter" class="form-label">Nama petugas : </label>
                <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" name="nama_petugas" id="nama_petugas" placeholder="Nama petugas" value="{{ old('nama_petugas') }}" required>
            @error('nama_dokter')
        ...
        @enderror
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir" id="tgl_lahir" placeholder="Nama petugas" value="{{ old('tgl_lahir') }}" required>
        @error('tgl_lahir')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" id="no_hp" placeholder="Nama petugas" value="{{ old('no_hp') }}" required>
        @error('no_hp')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
