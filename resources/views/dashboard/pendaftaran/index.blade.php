      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="clearfix">
            ...
            <a href="/dashboard/pendaftaran/create" class="btn btn-sm btn-danger mb-2"> <i class="mdi mdi-table-row-plus-before"></i> Tambah Data Pengunjung Baru</a>
