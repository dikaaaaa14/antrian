            ...
            <div class="col-md">
                <div class="card">
                    ...
                    <div class="alert alert-danger text-center" role="alert">
                      Pengunjung Sudah Teregistrasi di <strong>{{ $registrasi->layanan->nama_layanan }}</strong> 
                    </div>
                    @else
                    <form action="/dashboard/regpasien" method="post">
                      @csrf
                        ...
                        <div class="mb-3 row">
                            <label for="dokter" class="col-sm-3 col-form-label">Petugas</label>
                            <div class="col-sm-9">
                        ...
                        <div class="mb-3 row">
                            <label for="tipe_pasien" class="col-sm-3 col-form-label">Tipe Pengunjung</label>
                            <div class="col-sm-9">
                                <select class="form-select @error('tipe') is-invalid @enderror" name="tipe_pasien" id="tipe_pasien">
                                    <option selected disabled>Pilih Tipe Pengunjung</option>
                                    <option value="BPJS">ID Token</option>
                                    <option value="Umum">Baru</option>           
                                  </select>
                              @error('tipe')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                        ...
                        <div class="mb-3 row show-bpjs" style="display: none">
                          <label for="no_bpjs" class="col-sm-3 col-form-label">No ID Token : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control @error('no_bpjs') is-invalid @enderror" name="no_bpjs" id="no_bpjs" placeholder="Masukan No ID Token" value="{{ old('no_bpjs') }}">
                          @error('no_bpjs')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
