        ...
        <div class="card-body">
          ...
          <form action="/dashboard/layanan" method="post" class="col-6">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kd_layanan') is-invalid @enderror" name="kd_layanan" id="kd_layanan" placeholder="ex : Customer Service" value="{{ old('kd_layanan') }}" required autofocus>
            @error('kd_layanan')
